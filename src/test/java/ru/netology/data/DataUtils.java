...
public class DataUtils {
    ...
    public static String getCardNumberRusWords() {
        return "вапывлаопркеопро";
    }

    public static String getCardNumberEngWords() {
        return "dfjfkdhfjrtjghdf";
    }

    public static String getCardNumberSymbolsWords() {
        return "!@#!@$@!$#@$@#";
    }

    public static String getCardNumber10Digits() {
        return "4444444444";
    }
